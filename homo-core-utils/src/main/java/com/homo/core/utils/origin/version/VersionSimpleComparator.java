...
import com.homo.core.utils.origin.CharUtil;
 ...
 *
 */
public class VersionSimpleComparator implements Comparator<String>, Serializable {
	private static final long serialVersionUID = 8083701245147495562L;

	/** 单例 */
	public static final VersionSimpleComparator INSTANCE = new VersionSimpleComparator();

	/**
	 * 默认构造
	 */
	public VersionSimpleComparator() {
	}
	...
	public boolean equals(final Object object) {
		...
		if (object.getClass().equals(this.getClass())) {
			final VersionSimpleComparator other = (VersionSimpleComparator) object;
