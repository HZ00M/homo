...
public final class NumberUtil {
	 ...
	 * 如果是Null就返回默认值
	 *
	 * @param value {@link BigDecimal}，可以为{@code null}
	 * @param def 默认值
	...
	public static BigDecimal zeroToDefault(BigDecimal value,BigDecimal def) {
		return ( null == value || BigDecimal.ZERO.compareTo(value)==0 ) ? def : value;
	}
	...
	public static Long zeroToDefault(Long value,Long def) {
		return ( null == value || 0 == value ) ? def : value;
	}
	public static Long nullToZero(Long value) {
		return null == value ? 0 : value;
	}
	public static Integer nullToDefault(Integer value,Integer def) {
		return null == value ? def : value;
	}
	public static Integer zeroToDefault(Integer value,Integer def) {
		return ( null == value || 0 == value ) ? def : value;
	}
	...
	public static Short zeroToDefault(Short value,Short def) {
		return ( null == value || 0 == value ) ? def : value;
	}
	...
	public static Byte zeroToDefault(Byte value,Byte def) {
		return ( null == value || 0 == value ) ? def : value;
	}
	...
	public static Double zeroToDefault(Double value,Double def) {
		return ( null == value || 0 == value ) ? def : value;
	}
	...
	public static Float zeroToDefault(Float value,Float def) {
		return ( null == value || 0 == value ) ? def : value;
	}
	...
	public static int safeParseInt( String numbers) {
		if (numbers.length() > 9) {
	...
	public static boolean containsNumeric( final CharSequence cs) {
