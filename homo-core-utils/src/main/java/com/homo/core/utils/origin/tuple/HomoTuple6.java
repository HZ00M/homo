...
@Builder
public class HomoTuple6<T0, T1, T2, T3, T4, T5> extends HomoTuple {
	 ...
	 */
	public HomoTuple6(T0 value0, T1 value1, T2 value2, T3 value3, T4 value4, T5 value5) {
		this.f0 = value0;
		this.f1 = value1;
		this.f2 = value2;
		this.f3 = value3;
	...
	*/
	@Override
	@SuppressWarnings("unchecked")
	public HomoTuple6<T0, T1, T2, T3, T4, T5> copy() {
		return new HomoTuple6<>(this.f0,
			this.f1,
			this.f2,
			this.f3,
			this.f4,
	 ...
	 */
	public static <T0, T1, T2, T3, T4, T5> HomoTuple6<T0, T1, T2, T3, T4, T5> of(T0 value0, T1 value1, T2 value2, T3 value3, T4 value4, T5 value5) {
		return new HomoTuple6<>(value0,
			value1,
			value2,
			value3,
			value4,
