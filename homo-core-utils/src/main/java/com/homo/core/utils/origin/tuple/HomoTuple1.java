...
@Builder
public class HomoTuple1<T0> extends HomoTuple {
	...
	*/
	@Override
	@SuppressWarnings("unchecked")
	public HomoTuple1<T0> copy() {
		return new HomoTuple1<>(this.f0);
	}
	 ...
	 */
	public static <T0> HomoTuple1<T0> of(T0 value0) {
		return new HomoTuple1<>(value0);
	}
}
