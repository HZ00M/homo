...
@Builder
public class HomoTuple8<T0, T1, T2, T3, T4, T5, T6, T7> extends HomoTuple {
	 ...
	 */
	public HomoTuple8(T0 value0, T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7) {
		this.f0 = value0;
		this.f1 = value1;
		this.f2 = value2;
		this.f3 = value3;
	...
	*/
	@Override
	@SuppressWarnings("unchecked")
	public HomoTuple8<T0, T1, T2, T3, T4, T5, T6, T7> copy() {
		return new HomoTuple8<>(this.f0,
			this.f1,
			this.f2,
			this.f3,
			this.f4,
	 ...
	 */
	public static <T0, T1, T2, T3, T4, T5, T6, T7> HomoTuple8<T0, T1, T2, T3, T4, T5, T6, T7> of(T0 value0, T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7) {
		return new HomoTuple8<>(value0,
			value1,
			value2,
			value3,
			value4,
