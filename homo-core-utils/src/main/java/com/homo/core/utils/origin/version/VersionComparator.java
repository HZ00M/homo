 ...
 */
public class VersionComparator implements Comparable<VersionComparator>,Comparator<VersionComparator> {
  /**
   * 各版本子号对应的数组序号
   *
   */
   ...
   * 使用版本号字符串初始化
   */
  public VersionComparator(String versionString) {
   ...
   */
  public VersionComparator(String version, boolean throwExceptionIfVersionIllegal) {
   ...
   * @return
   */
  public int compareTo(VersionComparator otherVersion, boolean compareSuffix) {
  ...
  public int compareTo( String otherVersionString,boolean compareSuffix) {
    return compareTo(new VersionComparator(otherVersionString),compareSuffix);
  }
  @Override
  public int compareTo( VersionComparator otherVersion) {
  ...
  public boolean isHigher(VersionComparator otherVersion, boolean compareSuffix){
    return compareTo(otherVersion,compareSuffix)>0;
  }
  public boolean isHigher( String otherVersionString,boolean compareSuffix){
    return compareTo(otherVersionString,compareSuffix)>0;
  }
  public boolean isHigher( VersionComparator otherVersion){
    return compareTo(otherVersion)>0;
  }
  public boolean isHigher( String otherVersionString){
    return compareTo(otherVersionString)>0;
  }

  public boolean isLower(VersionComparator otherVersion, boolean compareSuffix){
    return compareTo(otherVersion,compareSuffix)<0;
  }
  public boolean isLower( String otherVersionString,boolean compareSuffix){
    return compareTo(otherVersionString,compareSuffix)<0;
  }
  public boolean isLower( VersionComparator otherVersion){
    return compareTo(otherVersion)<0;
  }
  public boolean isLower( String otherVersionString){
    return compareTo(otherVersionString)<0;
  }

  public boolean isEquals(VersionComparator otherVersion, boolean compareSuffix){
    return compareTo(otherVersion,compareSuffix)==0;
  }
  public boolean isEquals( String otherVersionString,boolean compareSuffix){
    return compareTo(otherVersionString,compareSuffix)==0;
  }
  public boolean isEquals( VersionComparator otherVersion){
    return compareTo(otherVersion)==0;
  }
  public boolean isEquals( String otherVersionString){
    return compareTo(otherVersionString)==0;
  }
   ...
   * @return
   */
  static int compareSubVersion( final List<Integer> versA, final List<Integer> versB) {
   ...
   * @return
   */
  private static int compareSuffix( final String suffixA,  final String suffixB,  final Comparator<String> ifEqualsComparator) {
  ...
  public static int compare(String versionString,String otherVersionString,boolean compareSuffix) {
    return new VersionComparator(versionString).compareTo(otherVersionString,compareSuffix);
  }

  public static int compare(String versionString,String otherVersionString) {
    return compare(versionString,otherVersionString,true);
  }

    @Override
    public int compare(VersionComparator o1, VersionComparator o2) {
  ...
  public boolean equals(Object o) {
    ...
    VersionComparator version = (VersionComparator) o;
