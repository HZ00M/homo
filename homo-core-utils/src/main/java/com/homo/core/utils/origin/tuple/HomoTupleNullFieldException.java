...
public class HomoTupleNullFieldException extends RuntimeException
{
	/**
	 ...
	 */
	public HomoTupleNullFieldException() {
		super();
		this.fieldPos = -1;
	}
	 ...
	 */
	public HomoTupleNullFieldException(String message) {
		super(message);
		this.fieldPos = -1;
	}
	 ...
	 */
	public HomoTupleNullFieldException(int fieldIdx) {
	 ...
	 */
	public HomoTupleNullFieldException(int fieldIdx, Throwable cause) {
