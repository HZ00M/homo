package com.homo.core.utils.origin.regex;
...
public class PatternPool {
	/** 英文字母和数字 **/
	public final static Pattern CHAR_NUMBER= Pattern.compile("[A-Za-z0-9]*");
	public final static Pattern PERMISSION= Pattern.compile("[A-Za-z0-9:]*");
	/** 英文字母 、数字和下划线 */
	...
	/** 单个中文汉字 */
	public final static Pattern CHINESE = Pattern.compile(RegexUtil.RE_CHINESE);
	/** 中文汉字 */
	public final static Pattern CHINESES = Pattern.compile(RegexUtil.RE_CHINESES);
	/** 分组 */
