...
public class NamedThreadFactory implements ThreadFactory {
     ...
     */
    private NamedThreadFactory(final Builder builder) {
     ...
     * </p>
     * <p>
     * Using this builder class instances of {@code NamedThreadFactory} can be
     * created and initialized. The class provides methods that correspond to
     * the configuration options supported by {@code NamedThreadFactory}. Method
     * chaining is supported. Refer to the documentation of {@code
     * NamedThreadFactory} for a usage example.
     * </p>
     *
     * NamedThreadFactory创建器<br>
     */
    public static class Builder {
        private static final long serialVersionUID = -974010695808408297L;
        ...
        private Thread.UncaughtExceptionHandler exceptionHandler= new DefaultThreadUncaughtExceptionHandler();
        ...
        /**
         * Sets the daemon flag for the new {@code NamedThreadFactory}. If this
        ...
        /**
         * Creates a new {@code NamedThreadFactory} with all configuration
         * options that have been specified by calling methods on this builder.
         * After creating the factory {@link #reset()} is called.
         *
         * @return the new {@code NamedThreadFactory}
         */
        public NamedThreadFactory build() {
            final NamedThreadFactory factory = new NamedThreadFactory(this);
            reset();
            return factory;
        }

        public static class DefaultThreadUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
