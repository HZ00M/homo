...
@Builder
public class HomoTuple3<T0, T1, T2> extends HomoTuple {
	 ...
	 */
	public HomoTuple3(T0 value0, T1 value1, T2 value2) {
		this.f0 = value0;
		this.f1 = value1;
		this.f2 = value2;
	}
	...
	*/
	@Override
	@SuppressWarnings("unchecked")
	public HomoTuple3<T0, T1, T2> copy() {
		return new HomoTuple3<>(this.f0,
			this.f1,
			this.f2);
	}
	 ...
	 */
	public static <T0, T1, T2> HomoTuple3<T0, T1, T2> of(T0 value0, T1 value1, T2 value2) {
		return new HomoTuple3<>(value0,
			value1,
			value2);
	}
}
