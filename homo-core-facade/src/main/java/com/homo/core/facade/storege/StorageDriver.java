...
public interface StorageDriver extends Driver {
     ...
     */
    void getAllKeysAndVal(String appId, String regionId, Integer logicType, String ownerId, CallBack<Map<String, byte[]>> callBack);
    /**
     ...
     */
    void asyncRemoveKeys(String appId, String regionId, Integer logicType, String ownerId, List<String> remKeys, CallBack<Boolean> callBack);
}
