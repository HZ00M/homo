...
public interface ISchemeMapper extends GeneralMapper {
    ...
    <T> List<T> loadAllDataObject(String appId, String regionId, String logicType, String ownerId);
    ...
    <T> List<T> loadDataObjectsByField(String appId, String regionId, String logicType, String ownerId, List<String> keys);
